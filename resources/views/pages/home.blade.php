            ...
            <a href="{{route('category.show', $category->slug)}}" class="card">
                <div
                    ...
                    <div class="flex flex-col gap-[2px]">
                        ...
                        <p class="text-sm text-ngekos-grey">{{$category->boardingHouses->count()}} Unit</p>
                    </div>
                </div>
            </a>
        </div>
                ...
                <a href="{{route('kos.show', $boardingHouse->slug)}}" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <hr class="border-[#F1F2F6]">
                            <p class="font-semibold text-lg text-ngekos-orange">Rp {{number_format($boardingHouse->price) }}<span
        ...
        <a href="{{route('city.show', $city->slug)}}" class="card">
            ...
            <div
                ...
                <div class="flex flex-col gap-[2px]">
                    ...
                    <p class="text-sm text-ngekos-grey">{{$city->boardingHouses->count()}} Unit</p>
                </div>
            </div>
        </a>
        @endforeach
